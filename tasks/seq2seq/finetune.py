...
from tasks.superglue.evaluate import squad_exact_match, squad_f1, qa_exact_match, qa_f1
...
def metrics_func_provider(args, tokenizer, is_test):
    ...
    if args.task.lower() in ['blank', 'extraction']:
        ...
        if args.tokenizer_type == "BertWordPieceTokenizer":
            ...
            dataset = 'cnn_dm_org'
        if args.task.lower() in ['squad', 'squad_v1', 'mlqa', 'tydiqa']:
